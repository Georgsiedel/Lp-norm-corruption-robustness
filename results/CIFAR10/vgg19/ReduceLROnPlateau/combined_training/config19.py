...
learningrate = 0.001
epochs = 200
lrparams = {'patience': 10, 'factor': 0.2, 'threshold': 0}
earlystop = True
...
mixup_alpha = 0.0 #default 0.2 #If both mixup and cutmix are >0, mixup or cutmix are selected by chance
cutmix_alpha = 0.0 # default 1.0 #If both mixup and cutmix are >0, mixup or cutmix are selected by chance
