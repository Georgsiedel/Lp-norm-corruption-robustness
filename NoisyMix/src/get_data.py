...
CIFAR10C_FOLDER = 'experiments/data/CIFAR10-c/'
CIFAR100C_FOLDER = 'experiments/data/CIFAR100-c/'
...
class CIFARCorrupt(VisionDataset):
    ...
    def __init__(self,
                 root='experiments/data/CIFAR10-c/',
                 severity=[1, 2, 3, 4, 5],
                 noise=None,
                 transform=None,
...
def getData(name='cifar10', train_bs=128, test_bs=512, train_path=None, test_path=None, severity=0, noise='fog'):
    ...
    if name == 'cifar10':
        ...
        trainset = datasets.CIFAR10(root='experiments/data', train=True, download=True, transform=transform_train)
        ...
        testset = datasets.CIFAR10(root='experiments/data', train=False, download=False, transform=transform_test)
        ...
        trainset = datasets.CIFAR100(root='experiments/data', train=True, download=True, transform=transform_train)
        train_loader = torch.utils.data.DataLoader(trainset,
                                                   batch_size=train_bs,
                                                   shuffle=True,
                                                   num_workers=4,
        ...
        testset = datasets.CIFAR100(root='experiments/data', train=False, download=False, transform=transform_test)
        test_loader = torch.utils.data.DataLoader(testset,
                                                  batch_size=test_bs,
                                                  shuffle=False,
                                                  num_workers=4,
